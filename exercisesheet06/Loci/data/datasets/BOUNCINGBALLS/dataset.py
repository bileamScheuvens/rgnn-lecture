...
class BouncingBallDataset(data.Dataset):
    ...
    def __init__(self, root_path: str, dataset_name: str, type: str, size: Tuple[int, int], type_name: str = None, full_size: Tuple[int, int] = None, create_dataset: bool = False):
        ...
        assert type_name in ["interaction", "occlusion", "twolayer", "twolayerdense", "twolayer_ood", "threelayer_ood"]

        data_path  = f'data/data/video/{dataset_name}'
        data_path  = os.path.join(root_path, data_path)
        print("Attempting to load the following BouncindBall dataset: ", dataset_name)
        ...
        if (type_name == "twolayer") or (type_name == "twolayer_ood" and type == "test") or (type_name == "threelayer_ood" and type != "test"):
            self.num_objects = 6
        ...
        if False:
            ...
            for t in range(video.shape[0]):
                ...
                for loc in locations[t]:
                    ...
                    frame[x_min:x_max, y_min:y_max, 1] = 255
